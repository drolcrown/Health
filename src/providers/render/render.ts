...
export class RenderProvider {
  ...
  public getColor(valor: number, contrast: number) {
    let colors = [
      ...
      'rgba(255, 159, 64, ' + contrast + ')',
      'rgba(	176	23	31	,' + contrast + ')',
      'rgba(	220	20	60	,' + contrast + ')',
      'rgba(	255	182	193	,' + contrast + ')',
      'rgba(	255	174	185	,' + contrast + ')',
      'rgba(	238	162	173	,' + contrast + ')',
      'rgba(	205	140	149	,' + contrast + ')',
      'rgba(	139	95	101	,' + contrast + ')',
      'rgba(	255	192	203	,' + contrast + ')',
      'rgba(	255	181	197	,' + contrast + ')',
      'rgba(	238	169	184	,' + contrast + ')',
      'rgba(	205	145	158	,' + contrast + ')',
      'rgba(	139	99	108	,' + contrast + ')',
      'rgba(	219	112	147	,' + contrast + ')',
      'rgba(	255	130	171	,' + contrast + ')',
      'rgba(	238	121	159	,' + contrast + ')',
      'rgba(	205	104	137	,' + contrast + ')',
      'rgba(	139	71	93	,' + contrast + ')',
      'rgba(	255	240	245	,' + contrast + ')',
      'rgba(	238	224	229	,' + contrast + ')',
